...
Tried reversing the image first using Yandex which gave me quite accurate results and eventually landed on the [Visitoslo](www.visitoslo.com/) page. Luckily, they gave a map full of statues, enough to give us the name of the creepy looking creature.
